...
public class MiniLifeDialog {
    ...
    //initialize variables/create all the arrays
        ...
        public String[] nameArrayFemale = {"Melissa", "Melonie", "Mallorie", "Melinda", "Linda", "Lacey", "Brooke", "Louisa", "Celeste", "Kaitlyn", "Mary-Ann", "Sandra", "Sandy", "Christine",
        ...
        public String[] nameArrayLast = {"Smith", "Nakamura", "Sanders", "O'Brian", "McDonald", "Chalamet", "Mongoose", "Montclare", "Barrymore", "Hylia", "Petersen", "Manguso", "Mancuso", "Munger",
...
//--BEGIN CODE SECTION--
    ...
    public String getDialogWithID(int dialogID){
        ...
        public String getVersionString(){
            String currentVersion = "Version 0.52-rc3-demo";
            return currentVersion;
    }      
    
        public String getDevelopmentMilestoneString(){
            String devMilestone = "Release Candidate 3";
            return devMilestone;
    }   
